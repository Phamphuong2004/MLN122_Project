...
export default function WelcomeScreen({ onStart }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Icon (SVG, replaces emoji for a consistent look) */}
        ...
        >
          <span style={{ color: "#00d4ff", fontSize: 13, letterSpacing: 2 }}>
            TRIẾT HỌC MÁC–LÊNIN • CHƯƠNG 6
          </span>
        </div>
        ...
        >
          ...
          >
            Qua 4 màn chơi tương tác • Lý luận Mác về giá trị • Chiến lược Việt
            Nam 2045
          </p>
          ...
          >
            {[
              ...
              >
                <span>{chip.icon}</span>
                <span style={{ color: chip.color, fontSize: 13 }}>
                  {chip.text}
                </span>
              </div>
            ))}
      ...
      <div
        style={{
          ...
          height: 2,
          background:
            "linear-gradient(90deg, transparent, #00d4ff, #f59e0b, #8b5cf6, transparent)",
        }}
      />
    </div>
  );
