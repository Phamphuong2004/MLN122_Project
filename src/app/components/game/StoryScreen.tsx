...
const panels = [
  {
    id: 0,
    icon: (
      <span className="presentation-icon" aria-hidden>
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M4 15v1a3 3 0 003 3h10a3 3 0 003-3v-1"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
          ...
          />
          <path
            d="M12 3c-3 0-5 2-5 5v2h10V8c0-3-2-5-5-5z"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    highlight:
      '"Lao động cụ thể" tạo ra chiếc áo (giá trị sử dụng) và "Lao động trừu tượng" hao phí sức người tạo ra Giá trị (value).',
    color: "#00d4ff",
  ...
  },
  {
    ...
    highlight:
      '"Thông báo: Nhà máy sẽ tự động hóa 60% dây chuyền trong 3 tháng tới. Một số vị trí sẽ bị cắt giảm."',
    color: "#ef4444",
  ...
  },
  {
    ...
    icon: (
      <span className="presentation-icon" aria-hidden>
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M9 18h6M10.5 6a3.5 3.5 0 117 0c0 2.5-3 4-3 4h-1s-3-1.5-3-4z"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    highlight:
      "Robot/AI có tạo ra giá trị mới không? Hay chúng chỉ chuyển giao giá trị từ máy móc vào sản phẩm? Và giá trị thặng dư đến từ đâu khi không còn lao động sống?",
    color: "#f59e0b",
  ...
  },
  {
    ...
    highlight:
      '"Phát triển nguồn nhân lực chất lượng cao – Không để ai bị bỏ lại phía sau trong cuộc cách mạng số."',
    color: "#10b981",
    ...
    >
      ...
      <div style={{ maxWidth: 700, width: "100%", zIndex: 10 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          >
            <span style={{ color: "#f59e0b", fontSize: 13, letterSpacing: 2 }}>
              📖 CÂU CHUYỆN MỞ ĐẦU
            </span>
          </div>
          <h2 style={{ color: "white", marginBottom: 0 }}>
            Từ Nhà Máy Đến Kỷ Nguyên AI
          </h2>
        </div>
          ...
          {panels.map((_, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 5,
                background:
                  i === currentPanel ? panel.color : "rgba(255,255,255,0.2)",
